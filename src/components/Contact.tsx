            ...
            <div>
              ...
              <div className="mt-10 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center gap-3">
                    <CheckCircle size={20} />
                    <span>Expert in DevOps & Infrastructure as Code</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle size={20} />
                    <span>Scalable & secure cloud solutions</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full px-6 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
